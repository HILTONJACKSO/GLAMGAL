      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-xs text-soft-stone leading-relaxed max-w-sm font-body">
              {f.brandDescription}
            </p>
          ...
          <div className="space-y-4">
            <h4 className="font-display text-xs tracking-widest text-warm-white uppercase border-b border-deep-charcoal pb-2 font-bold">
              CUSTOMER CARE
            </h4>
            <ul className="space-y-2 text-xs text-soft-stone font-body">
        ...
        <div className="pt-8 border-t border-deep-charcoal text-center text-xs text-warm-taupe tracking-wider font-display">
